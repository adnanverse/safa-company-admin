...
export default function ViewSize() {
    ...
    let deleteall = () => {
        if (confirm('are you sure you want to delete')) {
            axios.post('https://safa-company-api.onrender.com/api/admin/size/delete', {
                id: checkedvalue
            }, {
                headers: {
    ...
    let changeStatus = () => {
        axios.post('https://safa-company-api.onrender.com/api/admin/size/change-status', {
            id: checkedvalue
        }, {
            headers: {
                Authorization: `Bearer ${token}`
