               ...
               <nav class="flex border-b-2" aria-label="Breadcrumb">
                 <ol class="p-3 px-6 inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                   ...
                   <li aria-current="page">
                     <div class="flex items-center">/
                       <span class="ms-1 text-md font-medium text-gray-500 md:ms-2">View Sub Sub Category</span>
                     </div>
                   </li>
                 </ol>
               </nav>
                             ...
                             <th scope="col" class="px-6 w-[150px] py-3">
                               {
                                 (subSubcategory.length > 0)
                                   ...
                                   <input name="deleteCheck" onClick={SelectAll} id="purple-checkbox"
                                     type="checkbox"
                                     checked={
                                       (subSubcategory.length == checkedvalue.length) ? true : false}
                             ...
                             subSubcategory.map((v, i) => {
                               return (
                                 <tr class="bg-white border-b">
                                   ...
                                   <td class="px-6 py-4">{v.sub_category.name}</td>
                                   <td class="px-6 py-4">
                                     {
                                       v.name
                                     }
